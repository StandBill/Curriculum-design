...
<%
	...
	String sql = "select s.s_id,s.name,c.col_name,d.name,cl.name,s.grade,s.sex,s.reg_date,s.s_psw "+
				"from student s,class cl,college c,degress d where s.cl_id=cl.cl_id AND cl.col_id=c.col_id AND cl.d_id=d.d_id and s.s_id=?";
	String[] ar = {uid};
	ArrayList<HashMap<Integer,Object>> student = user.getList(sql, ar);
	HashMap<Integer,Object> t = student.get(0);
 %>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	<nav class="navbar navbar-default navbar-static-top navbar-inverse">
	  <div class="container-fluid">
	    ...
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="student_html/index.jsp">学生端</a>
	    </div>
      ...
      <ul class="ul_left">
          <li>
               <a id="select" onclick="setLiBgColor('select')" href="javascript:void(0)" target="_top" style="background-color:#232423;">
                   <img width="38" height="26" src="${pageContext.request.contextPath}/image/student.png"><br/>正选结果
               </a> 
           </li>
           <li>
	...
	<div id="student">
       <iframe id="student_info" src="${pageContext.request.contextPath}/student_html/course.jsp" width="99%" height="98%" style="border:0"></iframe>
   </div>
   <div id="teacher" style="display:none">
       <iframe id="student_info" src="${pageContext.request.contextPath}/student_html/course_index.jsp" width="99%" height="98%" style="border:0"></iframe>
   </div>
		  ...
		  <div class="modal-dialog modal-sm" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
					<div class="input-group input-group-lg">
						<table>
							...
							<tr>
								<td>登录密码</td>
								<td>
									<input type="text" name="psw" value="<%=t.get(9) %>" required/>
								</td>
					...
					<input type="hidden" name="status" value="stu_up_psw" class="form-control"/>
		      </div>
